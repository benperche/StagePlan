...
export const handleTip = document.getElementById('handle-tip') as HTMLElement
...
export const resetColorsBtn = document.getElementById('reset-colors-btn') as HTMLButtonElement
...
export const labelList = document.getElementById('label-list') as HTMLElement
...
export const inspectorTimpaniOptions = document.getElementById('inspector-timpani-options') as HTMLElement
export const inspectorTimpaniStool = document.getElementById('inspector-timpani-stool') as HTMLInputElement
