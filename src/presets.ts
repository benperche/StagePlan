    ...
    customRows: [
      ...
      },
      {
        ...
        chairs: [
          ...
          { label: '',     color: COLORS.woodwind, enabled: false },
          { label: '',     color: COLORS.woodwind, enabled: false },
          { label: 'Alto S 1',  color: COLORS.woodwind, hasStand: true },
          { label: 'Alto S 1',  color: COLORS.woodwind, hasStand: true },
          { label: 'Alto S 2',  color: COLORS.woodwind, hasStand: true },
          { label: 'Alto S 2',  color: COLORS.woodwind, hasStand: true },
          { label: 'Tenor S',   color: COLORS.woodwind, hasStand: true },
          { label: 'Tenor S',   color: COLORS.woodwind, hasStand: true },
          { label: 'Bari S',    color: COLORS.woodwind, hasStand: true },
          { label: '',     color: COLORS.woodwind, enabled: false },
          { label: '',     color: COLORS.woodwind, enabled: false },
          { label: '',     color: COLORS.woodwind, enabled: false },
        ],
